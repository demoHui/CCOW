...
//END exit
//BEGIN replay
    RAddr raddr;//record of access address physic address
//END replay
  #endif
/*
#ifdef SESC_COW
  ...
  bool elmMiss;
  ExePath exePath;
  void setSpecFlag(bool flag){spec = flag;}
  bool getSpecFlag(){return spec;}
#endif
#ifdef SESC_COW_REPLAY
  bool isExitInst;
  bool waitExit;//no use
   RAddr raddr;
#endif
...
#endif
#if (SESC_REMOTE||SESC_COW_REMOTE)
  bool remoteLoad;
#endif
